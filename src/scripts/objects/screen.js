...
const screen = {
    ...
    renderUser(user) {
        ...
        user.repositories.forEach((repo, index) => repositoriesItens += `<li>
                                                                          <a href="${repo.html_url}" target="_blank">${repo.name}
                                                                                <ul class="repo-info">
                                                                                    <li class="i">${"🍴"}${repo.forks ?? 'Sem forks'}</li>
                                                                                    <li class="i">${"⭐"}${repo.stargazers_count ?? 'Sem estrelas'}</li>
                                                                                    <li class="i">${"👀"}${repo.watchers}</li>
                                                                                    <li class="i">${"🧑‍💻"}${user.repo_language[index] ?? "Sem linguagem "}</li>
                                                                                </ul>
                                                                            </a>
                                                                        </li>`)
